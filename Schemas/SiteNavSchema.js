...
const childNavItems = [
  ...
  { parent_key: 'nav.administration', label: 'Executive Council', path: '/administration/ec-council', reference_key: 'nav.administration.executive-council', cms_section: 'governance', sort_order: 30 },
  { parent_key: 'nav.administration', label: 'Registrar', path: '/administration/registrar', reference_key: 'nav.administration.registrar', cms_section: 'directors', sort_order: 40 },
  { parent_key: 'nav.administration', label: 'Officer on Special Duty (OSD)', path: '/administration/osd', reference_key: 'nav.administration.osd', cms_section: 'directors', sort_order: 50 },
